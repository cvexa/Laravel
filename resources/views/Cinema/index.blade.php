...
<!-- 	<div id="slidey" style="display:none;">
		<ul>
			<li><img src="images/5.jpg" alt=" "><p class='title'>{{ $movies->title }}</p><p class='description'> {{ $movies->description }} <button class="btn-warning"><b>Buy Ticket</b></button>
			<a href="#small-dialog1"><button class="btn-warning"><b>Watch Trailer</b></button></a></p></li>
...
<!-- Latest-tv-series -->
	<div class="Latest-tv-series">
		<h4 class="latest-text w3_latest_text w3_Monday_popular">Премиери</h4>
		<div class="container">
							...
							<div class="agile_tv_series_grid">
								<div class="col-md-6 agile_tv_series_grid_left">
									<div class="w3ls_market_video_grid1">
										<img src="images/5-1.jpg" alt=" " class="img-responsive" />
								...
								<div class="col-md-6 agile_tv_series_grid_right">
									<p class="fexi_header">{{ $movies -> title }}</p>
									<p class="fexi_header_para"><span class="conjuring_w3">Описание<label>:</label></span> {{$movies -> description }}  </p>
									<p class="fexi_header_para"><span>Премиера<label>:</label></span> {{$movies -> start_date}}</p>
									<p class="fexi_header_para">
										<span>Жанр:<label>:</label> </span>
										<a href="genres.html">{{$movies -> cl_genre_id1}}</a> | 
										<a href="genres.html">{{$movies -> cl_genre_id2}}</a> | 
										<a href="genres.html">{{$movies -> cl_genre_id3}}</a>								
									</p>
									<p class="fexi_header_para fexi_header_para1"><span>Рейтинг<label>:</label></span>
									{{$movies -> rating}} / 10
...
<!-- banner-bottom -->
	...
	<div class="general">
		...
		<div class="container">
			<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
				<ul id="myTab" class="nav nav-tabs" role="tablist">
					<li role="presentation" class="active"><a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">Всички</a></li>
					<li role="presentation"><a href="#Monday" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile" aria-expanded="false">Понеделник</a></li>
					<li role="presentation"><a href="#Tuesday" id="rating-tab" role="tab" data-toggle="tab" aria-controls="rating" aria-expanded="true">Вторник</a></li>
					<li role="presentation"><a href="#Wednesday" role="tab" id="imdb-tab" data-toggle="tab" aria-controls="imdb" aria-expanded="false">Сряда</a></li>
					<li role="presentation"><a href="#Thursday" role="tab" id="imdb-tab" data-toggle="tab" aria-controls="imdb" aria-expanded="false">Четвъртък</a></li>
					<li role="presentation"><a href="#Friday" role="tab" id="imdb-tab" data-toggle="tab" aria-controls="imdb" aria-expanded="false">Петък</a></li>
					<li role="presentation"><a href="#Saturday" role="tab" id="imdb-tab" data-toggle="tab" aria-controls="imdb" aria-expanded="false">Събота</a></li>
					<li role="presentation"><a href="#Sunday" role="tab" id="imdb-tab" data-toggle="tab" aria-controls="imdb" aria-expanded="false">Неделя</a></li>
				</ul>
				<div id="myTabContent" class="tab-content">
					<div role="tabpanel" class="tab-pane fade active in" id="home" aria-labelledby="home-tab">
						<div class="w3_agile_featured_movies">
							...
							<div class="col-md-2 w3l-movie-gride-agile">
								<a href="/single" class="hvr-shutter-out-horizontal"><img src="images/m5.jpg" title="album-name" class="img-responsive" alt=" " />
									<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
								</a>
								<div class="mid-1 agileits_w3layouts_mid_1_home">
									<div class="w3l-movie-text">
							...
							<div class="col-md-2 w3l-movie-gride-agile">
								<a href="/single" class="hvr-shutter-out-horizontal"><img src="images/m16.jpg" title="album-name" class="img-responsive" alt=" " />
									<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
								</a>
								<div class="mid-1 agileits_w3layouts_mid_1_home">
									<div class="w3l-movie-text">
							...
							<div class="col-md-2 w3l-movie-gride-agile">
								<a href="/single" class="hvr-shutter-out-horizontal"><img src="images/m18.jpg" title="album-name" class="img-responsive" alt=" " />
									<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
								</a>
								<div class="mid-1 agileits_w3layouts_mid_1_home">
									<div class="w3l-movie-text">
							...
							<div class="col-md-2 w3l-movie-gride-agile">
								<a href="/single" class="hvr-shutter-out-horizontal"><img src="images/m1.jpg" title="album-name" class="img-responsive" alt=" " />
									<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
								</a>
								<div class="mid-1 agileits_w3layouts_mid_1_home">
									<div class="w3l-movie-text">
							...
							<div class="col-md-2 w3l-movie-gride-agile">
								<a href="/single" class="hvr-shutter-out-horizontal"><img src="images/m14.jpg" title="album-name" class="img-responsive" alt=" " />
									<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
								</a>
								<div class="mid-1 agileits_w3layouts_mid_1_home">
									<div class="w3l-movie-text">
							...
							<div class="col-md-2 w3l-movie-gride-agile">
								<a href="/single" class="hvr-shutter-out-horizontal"><img src="images/m19.jpg" title="album-name" class="img-responsive" alt=" " />
									<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
								</a>
								<div class="mid-1 agileits_w3layouts_mid_1_home">
									<div class="w3l-movie-text">
					...
					<div role="tabpanel" class="tab-pane fade" id="Wednesday" aria-labelledby="Wednesday-tab">
						...
						<div class="col-md-2 w3l-movie-gride-agile">
							<a href="/single" class="hvr-shutter-out-horizontal"><img src="images/m23.jpg" title="album-name" class="img-responsive" alt=" " />
								<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
							</a>
							<div class="mid-1 agileits_w3layouts_mid_1_home">
								<div class="w3l-movie-text">
